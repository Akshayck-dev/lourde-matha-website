...
const inputClass =
  'w-full rounded-2xl border border-maroon/15 bg-white/70 px-5 py-4 text-[15px] font-light text-charcoal placeholder:text-charcoal/35 outline-none transition-all duration-300 focus:border-gold focus:bg-white focus:shadow-card';
...
function ContactForm() {
  ...
  if (sent) {
    return (
      <div className="flex h-full min-h-[420px] flex-col items-center justify-center rounded-3xl border border-maroon/10 bg-white/60 p-10 text-center shadow-card">
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-3xl border border-maroon/10 bg-white/60 p-7 shadow-card md:p-10">
